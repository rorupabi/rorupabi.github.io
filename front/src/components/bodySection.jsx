      ...
      <div className='flex flex-wrap lg:flex-row-reverse'>
        <div className="w-full lg:w-1/2">
          <div className='flex justify-center lg:-8'>
            <img src={ProfilePic} alt="Rouen Padilla" className='p-12' />
          </div>
        </div>
        <div className='w-full lg:w-1/2'>
          <div className='flex flex-col items-center lg:items-start mt-10'>
            <h2 className='pb-2 text-3xl tracking-tighter lg:text-6xl'>Rouen Padilla</h2>
            ...
            <a href="https://www.canva.com/design/DAGY42H07Tg/hgU1RlZ5WS0EBSiF3gBhkA/view?utm_content=DAGY42H07Tg&utm_campaign=designshare&utm_medium=link2&utm_source=uniquelinks&utlId=heaab2b2388"
              ...
              download
              className='bg-white rounded-full p-4 text-sm text-stone-800 mb-5'>
              Download Resume
            </a>
          </div>
        </div>
