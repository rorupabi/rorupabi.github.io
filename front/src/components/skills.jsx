...
import { FaNode, FaJava, FaVuejs, FaFigma, FaWix} from "react-icons/fa";
...
const Skills = () => {
  const skills = [
    ...
    { Icon: FaWordpress, color: "text-blue-400", name: "WordPress" },
    { Icon: FaWix, color: "text-purple-500", name: "Wix" },
    { Icon: SiElementor, color: "text-red-500", name: "Elementor" }
  ];
